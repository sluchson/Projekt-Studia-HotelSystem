...
public:
    ...
    void setupUi(QMainWindow *addrental)
    {
        ...
        dateEdit_checkin->setGeometry(QRect(350, 200, 110, 29));
        dateEdit_checkout = new QDateEdit(centralwidget);
        dateEdit_checkout->setObjectName("dateEdit_checkout");
        dateEdit_checkout->setGeometry(QRect(350, 260, 110, 29));
        ...
        lineEdit_price->setGeometry(QRect(300, 320, 201, 28));
        ...
        labelClients->setGeometry(QRect(20, 10, 231, 49));
        QFont font;
