...
template <> constexpr inline auto roomwindow::qt_create_metaobjectdata<qt_meta_tag_ZN10roomwindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<roomwindow, qt_meta_tag_ZN10roomwindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject roomwindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10roomwindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10roomwindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10roomwindowE_t>.metaTypes,
    nullptr
} };
...
void *roomwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10roomwindowE_t>.strings))
